...
export default function Footer({ translations }) {
  ...
  return (
    <footer
      className="pt-[3rem] pb-[5rem] px-8"
      style={{
        background:
          "linear-gradient(0.219turn, rgba(251, 251, 253, 1) 0%, rgba(235, 240, 253, 0.8) 100%)",
      }}
    >
      {/* content container */}
      <div
      ...
      >
        ...
        <div className="flex flex-col text-[0.875rem] text-less-dark">
          ...
          <div className="flex items-center">
            <div className="font-normal text-[0.75rem] text-black">
              {f.resident}
            </div>
        ...
        <div className="flex flex-col">
          <p
            className={`text-dark text-[1.25rem] font-semibold ${titleHeight} ${mbAfterTitle}`}
          >
            {f.forClients.title}
          </p>
          <ul>
        ...
        <div className="flex flex-col gap-y-[0.9rem] items-end font-medium">
          <a
            ...
            className="font-bold text-[2.1875rem] leading-[1] text-dark"
          >
            {phone.phone}
          </a>
